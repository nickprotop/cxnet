...
echo "  https://github.com/nickprotop/cxnet/actions"
echo ""
echo "Release will be at:"
echo "  https://github.com/nickprotop/cxnet/releases/tag/$NEW_TAG"
